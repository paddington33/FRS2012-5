...
(cl:defmethod cl:initialize-instance :after ((m <accelerometer>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'accelerometer)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name IMUDriver-msg:<accelerometer> is deprecated: use IMUDriver-msg:accelerometer instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <accelerometer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader IMUDriver-msg:header-val is deprecated.  Use IMUDriver-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <accelerometer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader IMUDriver-msg:x-val is deprecated.  Use IMUDriver-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <accelerometer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader IMUDriver-msg:y-val is deprecated.  Use IMUDriver-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <accelerometer>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader IMUDriver-msg:z-val is deprecated.  Use IMUDriver-msg:z instead.")
  (z m))
